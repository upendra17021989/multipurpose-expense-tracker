...
public class KiranaSalesController {
    ...
    @PutMapping("/{saleId}")
    public ResponseEntity<SaleDto> updateSale(@AuthenticationPrincipal UserPrincipal userPrincipal, @PathVariable Long saleId, @Valid @RequestBody SaleCreateRequest request) {
        return ResponseEntity.ok(saleService.updateSale(userPrincipal.getAccountId(), saleId, request));
    }

    @DeleteMapping("/{saleId}")
    public ResponseEntity<Void> cancelSale(@AuthenticationPrincipal UserPrincipal userPrincipal, @PathVariable Long saleId) {
        saleService.cancelSale(userPrincipal.getAccountId(), saleId);
