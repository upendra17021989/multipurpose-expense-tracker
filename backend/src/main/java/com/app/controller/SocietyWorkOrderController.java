...
@RestController @RequestMapping("/society/work-orders") @RequiredArgsConstructor public class SocietyWorkOrderController {private final SocietyWorkOrderService service;
