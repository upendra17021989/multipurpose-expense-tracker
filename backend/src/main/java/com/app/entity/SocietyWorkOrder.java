...
import jakarta.persistence.*; import lombok.*; import java.math.BigDecimal; import java.time.LocalDate; import java.time.LocalDateTime;
...
public class SocietyWorkOrder {
 ...
 @Column(length=20) private String recurrenceType; private Integer recurrenceInterval; private LocalDate recurrenceEnd; private LocalDateTime nextOccurrence; @ManyToOne(fetch=FetchType.LAZY) @JoinColumn(name="recurring_parent_id") private SocietyWorkOrder recurringParent;
