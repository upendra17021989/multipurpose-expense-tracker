...
const SocietyDashboard = () => {
  ...
  if (role === 'STAFF') return <Shell title="Worker Self-Service" eyebrow="Society workforce"><section className="report-panel"><h2>Today's shift</h2><p className="muted">Record your own shift check-in and check-out.</p><DashboardAction to="/society/attendance/self" icon="At" title="My Attendance" text="View today's assignment and attendance times" /></section></Shell>
  if (role === 'STAFF_SUPERVISOR') return <Shell title="Supervisor Dashboard" eyebrow="Society operations"><section className="report-panel"><h2>Operational workspace</h2><p className="muted">Record today's workforce attendance and review operational assignments.</p><div className="dashboard-actions"><DashboardAction to="/society/daily-operations" icon="Op" title="Daily Operations" text="Checklist, incidents, inspections, handover, and daily report" /><DashboardAction to="/society/attendance" icon="At" title="Today's Attendance" text="Mark attendance, check-in, and check-out" /><DashboardAction to="/society/staff" icon="St" title="Staff" text="View society staff records" /><DashboardAction to="/society/agencies" icon="Ag" title="Agencies & Workers" text="Review outsourced workforce and headcount" /><DashboardAction to="/society/roster" icon="Sh" title="Shifts & Roster" text="Review posts and current assignments" /><DashboardAction to="/society/vendors" icon="Vn" title="Vendors" text="View and update vendor details" /></div></section></Shell>
...
export const SocietyMemberDirectory = ({ view = 'directory' }) => {
  ...
  useEffect(() => {
    if (!isAdmin || view !== 'ledger' || !visibleLedgerFlats.length) return
  ...
  return (
    ...
    <section className="panel">
      ...
      {view === 'directory' && <><h2>Society member directory</h2>
...
export const SocietyFinancialLedger = () => <SocietyMemberDirectory view="ledger" />
