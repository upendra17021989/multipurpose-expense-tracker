    ...
    <nav className="navbar">
      <div className="nav-container">
        <div className="nav-topline">
          <Link className="nav-logo" to="/home" onClick={() => setMenuOpen(false)}>Expense Tracker</Link>
          <button
            type="button"
          ...
          <div className="nav-links">
            ...
            <div className={`nav-dropdown ${moduleOpen ? 'open' : ''}`}>
              ...
              <div className="nav-dropdown-panel">
                ...
                {currentAccount?.accountType === 'INDIVIDUAL' && <Link to="/personal/friends" onClick={closeMenus}>Friends</Link>}
                ...
                {currentAccount?.accountType === 'KIRANA_STORE' && <Link to="/kirana/purchases" onClick={closeMenus}>Purchases</Link>}
                {currentAccount?.accountType === 'KIRANA_STORE' && <Link to="/kirana/suppliers" onClick={closeMenus}>Suppliers</Link>}
                {currentAccount?.accountType === 'KIRANA_STORE' && <Link to="/kirana/customers" onClick={closeMenus}>Customers</Link>}
            ...
            <div className={`nav-account ${accountOpen ? 'open' : ''}`}>
              ...
              <div className="nav-account-panel">
                ...
                {accounts.length <= 1 && currentAccount && (
                  <p className="nav-account-name">{currentAccount.accountName}</p>
                )}
