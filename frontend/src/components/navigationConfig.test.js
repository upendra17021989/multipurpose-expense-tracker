...
describe('sidebar navigation configuration', () => {
  ...
  it('limits staff supervisors to operational navigation', () => {
    ...
    expect(items).toEqual(['Daily Operations', 'Work Orders', 'Complaints', 'Notifications', "Today's Attendance", 'Attendance Reports', 'Staff', 'Agencies & Workers', 'Shifts & Roster', 'Vendors', 'Feedback'])
  })
